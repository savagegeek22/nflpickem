...
<body>
	<div class="container">
		<form class="form-signin" role="form" action="login.php" method="POST">
			<h2 class="form-signin-heading">SG NFL Picks 2024</h2>
			<?php
			//print_r($_POST);
			...
			if (ALLOW_SIGNUP && SHOW_SIGNUP_LINK) {
				echo '<p><a href="signup.php">Click here to sign up for an account. Deadline by Sept 24th</a></p>';
			}
			?>
